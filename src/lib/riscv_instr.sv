...
package riscv_instr;
  ...
  localparam [31:0] BEQI               = 32'b?????????????????010?????1100011;
  ...
  localparam [31:0] BNEI               = 32'b?????????????????011?????1100011;
  ...
  localparam [31:0] LB_AQ              = 32'b001101?00000?????000?????0101111;
  localparam [31:0] LBU                = 32'b?????????????????100?????0000011;
  localparam [31:0] LD                 = 32'b?????????????????011?????0000011;
  localparam [31:0] LD_AQ              = 32'b001101?00000?????011?????0101111;
  localparam [31:0] LH                 = 32'b?????????????????001?????0000011;
  localparam [31:0] LH_AQ              = 32'b001101?00000?????001?????0101111;
  localparam [31:0] LHU                = 32'b?????????????????101?????0000011;
  localparam [31:0] LR_D               = 32'b00010??00000?????011?????0101111;
  localparam [31:0] LR_W               = 32'b00010??00000?????010?????0101111;
  localparam [31:0] LUI                = 32'b?????????????????????????0110111;
  localparam [31:0] LW                 = 32'b?????????????????010?????0000011;
  localparam [31:0] LW_AQ              = 32'b001101?00000?????010?????0101111;
  ...
  localparam [31:0] SB_RL              = 32'b00111?1??????????000000000101111;
  ...
  localparam [31:0] SD_RL              = 32'b00111?1??????????011000000101111;
  ...
  localparam [31:0] SH_RL              = 32'b00111?1??????????001000000101111;
  ...
  localparam [31:0] SW_RL              = 32'b00111?1??????????010000000101111;
  ...
  localparam [31:0] VFBDOT_VV          = 32'b101011???????????001?????1110111;
  ...
  localparam [31:0] VFEXT_VF2          = 32'b010010??????10110010?????1010111;
  ...
  localparam [31:0] VFNCVT_F_F_Q       = 32'b010010??????11001001?????1010111;
  ...
  localparam [31:0] VFNCVT_SAT_F_F_Q   = 32'b010010??????11011001?????1010111;
  ...
  localparam [31:0] VFNCVTBF16_SAT_F_F_W = 32'b010010??????11111001?????1010111;
  ...
  localparam [31:0] VFQBDOT_ALT_VV     = 32'b101111???????????001?????1110111;
  localparam [31:0] VFQBDOT_VV         = 32'b101110???????????001?????1110111;
  localparam [31:0] VFQLDOT_ALT_VV     = 32'b100111???????????001?????1110111;
  localparam [31:0] VFQLDOT_VV         = 32'b100110???????????001?????1110111;
  ...
  localparam [31:0] VFWBDOT_VV         = 32'b101100???????????001?????1110111;
  ...
  localparam [31:0] VFWLDOT_VV         = 32'b100100???????????001?????1110111;
  ...
  localparam [31:0] VQBDOTS_VV         = 32'b101111???????????000?????1110111;
  localparam [31:0] VQBDOTU_VV         = 32'b101110???????????000?????1110111;
  localparam [31:0] VQDOT_VV           = 32'b101100???????????010?????1010111;
  localparam [31:0] VQDOT_VX           = 32'b101100???????????110?????1010111;
  localparam [31:0] VQDOTSU_VV         = 32'b101010???????????010?????1010111;
  localparam [31:0] VQDOTSU_VX         = 32'b101010???????????110?????1010111;
  localparam [31:0] VQDOTU_VV          = 32'b101000???????????010?????1010111;
  localparam [31:0] VQDOTU_VX          = 32'b101000???????????110?????1010111;
  localparam [31:0] VQDOTUS_VX         = 32'b101110???????????110?????1010111;
  localparam [31:0] VQLDOTS_VV         = 32'b100111???????????000?????1110111;
  localparam [31:0] VQLDOTU_VV         = 32'b100110???????????000?????1110111;
